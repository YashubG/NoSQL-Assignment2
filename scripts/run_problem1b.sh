...
echo "======================================="
echo "Running Problem 1(b): PAIRS (Local Mode)"
echo "======================================="
...
JAR_NAME="problem1b_local.jar"

INPUT="$PROJECT_ROOT/Data/wiki_all_fixed.txt"
TOP50="$PROJECT_ROOT/top50.txt"
OUTPUT_BASE="$PROJECT_ROOT/output/problem1b_local"
...
javac -classpath "$(hadoop classpath)" -d "$BUILD_DIR" \
    "$SRC_DIR/problem1/Problem1b_Pairs_Local.java"
...
hadoop jar "$BUILD_DIR/$JAR_NAME" problem1.Problem1b_Pairs_Local \
    "$INPUT" \
    "$OUTPUT" \
    "$TOP50" \
    "$DIST"
