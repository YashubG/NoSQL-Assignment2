...
echo "======================================="
echo "Running Problem 1(c): STRIPES (Local Mode)"
echo "======================================="
...
JAR_NAME="problem1c_local.jar"

INPUT="$PROJECT_ROOT/Data/wiki_all_fixed.txt"
TOP50="$PROJECT_ROOT/top50.txt"
OUTPUT_BASE="$PROJECT_ROOT/output/problem1c_local"
...
javac -classpath "$(hadoop classpath)" -d "$BUILD_DIR" \
    "$SRC_DIR/problem1/Problem1c_Stripes_Local.java"
...
hadoop jar "$BUILD_DIR/$JAR_NAME" problem1.Problem1c_Stripes_Local \
    "$INPUT" \
    "$OUTPUT" \
    "$TOP50" \
    "$DIST"
